...
- 고객 이탈률에 영향을 미치는 컬럼을 찾기 위한 모델링 진행
  - Optuna를 활용하여 RandomForest의 최적의 파라미터 탐탐색
...
- 정시 배송에 실패한 건에 대한 분석 결과 배송 문제가 98.9%, 제품 준비 문제가 10.1%임을 확인
  - 배송 문제가 발생한 경우(제품 준비 기간보다 실제 배송 기간이 긴 경우)는 정시 배송 실패의 89.9%를 차지하므로 실제 배송 기간에 초점을 맞추는 것이 적합하다고 판단
- 구매자는 북부를 제외한 전 지역에 고르게 분포되어 있으나 남동부에 집중 분포되어 있음
- 판매자는 남동부에 집중 분포되어 있음
- 주, 지역별 평균 배송기간과 배송량 또한 남동부로 갈수록 배송기간이 짧고 배송량이 많아짐
